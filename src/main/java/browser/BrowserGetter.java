...
public class BrowserGetter {
    ...
    public WebDriver getChromeDriver() {
        ...
        if (IS_OS_WINDOWS) {
            setProperty("webdriver.chrome.driver", "C:\\Users\\LENOVO\\Desktop\\Work\\GBHAutomation\\src\\test\\Browerdrivers\\chromedriver.exe");
        }
        if (IS_OS_LINUX) {
            setProperty("webdriver.chrome.driver", "C:\\Users\\LENOVO\\Desktop\\Work\\GBHAutomation\\src\\test\\Browerdrivers\\chromedriver");
        }
        if (IS_OS_MAC) {
            setProperty("webdriver.chrome.driver", "C:\\Users\\LENOVO\\Desktop\\Work\\GBHAutomation\\src\\test\\Browerdrivers\\chromedriverMac");
        }
